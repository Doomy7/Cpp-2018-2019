...
//------------------------------------ class Image ------------------------------------------------
	 ...
	 * 
	 * It holds the actual buffer of the cell values and provides methods for accessing them, 
	 * either as individual cells or as a memory block. The Image class alone does not provide 
